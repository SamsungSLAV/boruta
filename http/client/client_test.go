...
func TestVersion(t *testing.T) {
	...
	header := make(http.Header)
	header.Set("Boruta-Server-Version", valid.BorutaVersion.Server)
	header.Set("Boruta-API-Version", valid.BorutaVersion.API)
	header.Set("Boruta-API-State", valid.BorutaVersion.State)
