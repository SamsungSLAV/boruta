...
// Package api aggregates all availabe Boruta HTTP API versions. It also take care of CORS headers.
// When API version was omitted in HTTP request then it will be redirected to default API version
// (latest stable).
package api
